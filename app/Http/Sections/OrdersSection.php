 ...
 * Class OrdersSection
 *
 * @property \App\Models\UserOrder $model
 *
...
class OrdersSection extends Section implements Initializable
{
    ...
    {
        $this->addToNavigation()->setPriority(100)->setIcon('fa fa-reply');
    }
    ...
    public function onDisplay($payload = [])
    {
        $columns = [
            ...
            AdminColumn::text('title', 'Title')
                ...
                ->setSearchable(true)
            ,
            AdminColumn::text('email', 'User Email')
                ->setWidth('200px')
                ->setOrderable(function($query, $direction) {
        ...
        $display->setColumnFilters([
            AdminColumnFilter::select()
                ->setModelForOptions(\App\Models\UserOrder::class, 'name')
